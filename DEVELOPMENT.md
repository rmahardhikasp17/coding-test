...
```bash
git remote add encore encore://crud-app-with-api-yrx2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/crud-app-with-api-yrx2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/crud-app-with-api-yrx2/settings/integrations/github)
